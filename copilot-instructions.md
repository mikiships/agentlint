...
## Directory Structure
**Top-level directories:** `.github`, `.ruff_cache`, `.uv-cache`, `scripts`, `src`, `tests`
**Source roots:** `src`
**Test roots:** `tests`
**Most-changed directories:** `tests`, `src`, `pyproject.toml`, `README.md`, `CHANGELOG.md`
...
**Commit prefix style:** `feat`, `chore`, `add`, `d1`, `d2+d3` (follow this pattern)
**Common file extensions:** `.py`, `.md`, `.toml`, `.yml`, `[no_ext]`
